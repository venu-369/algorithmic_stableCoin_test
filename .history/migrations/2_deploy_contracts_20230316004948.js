...
module.exports = async function (deployer, network, accounts) {
  ...
  const initialSupply = web3.utils.toWei("10", "ether"); // Set the initial supply to 1,000,000 tokens
  ...
  const initialPrice = 200000; // Replace with the initial price you want to set (8 decimals)
  ...
  await stablecoinInstance.setPriceFeed(priceFeedInstance.address);
};
